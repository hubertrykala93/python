...
class Menu:
    ...
    def product_info(self, category: str) -> dict:
        ...
        for product in Menu(file_path=self.filepath).load_menu().items():
    ...
    def add_product(self, category: str, **kwargs) -> None:
        """
        Adding new product to the menu and overwriting json file.
        :param category: str
        :param kwargs: str
        :return: None
        """
        menu = Menu(file_path=self.filepath).load_menu()
    ...
    def remove_product(self, category: str, name: str) -> None:
        """
        Removing a product from the menu and overwriting json file.
        :param category: str
        :param name: str
        :return: None
        """
